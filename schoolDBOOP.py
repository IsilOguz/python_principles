...
s1 = Student (101, "Ali", "Ak", "12345", "1000")
print (s1.sNumber,s1.name,s1.surname,s1.phone,s1.wallet)
print (s1.__dict__)

s2 = Student (102, "Ayşe", "Al", "99999", "500")
print (s2.sNumber,s2.name,s2.surname,s2.phone,s2.wallet)
print (s2.__dict__)

s3 = Student (103, "Zeynep", "Yıldırım", "21222", "900")
print (s3.sNumber,s3.name,s3.surname,s3.phone,s3.wallet)
print (s3.__dict__)

s4 = Student (104, "Mehmet", "Gök", "13579", "400")
print (s4.sNumber,s3.name,s3.surname,s3.phone,s3.wallet)
print (s4.__dict__)